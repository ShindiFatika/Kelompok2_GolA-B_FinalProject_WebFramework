<?php
echo "<p class='sidebar-title'> REGISTRASI</p>
...
echo form_open_multipart('auth/register',$attributes); 
  echo "<div class='form-group'>
            ...
            <div class='col-sm-9'>
            <div style='background:#FFE4E1;' class='input-group col-sm-12'>
        ...
        <div class='form-group'>
            ...
            <div class='col-sm-9'>
            <div style='background:#FFE4E1;' class='input-group col-sm-6'>
        ...
        <div class='form-group'>
            ...
            <div class='col-sm-9'>
            <div style='background:#FFE4E1;' class='input-group col-lg-12'>
